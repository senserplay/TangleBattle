...
- **Heaven's Wrath**: ширина столбов света растёт, расстояние
  ...
  На **максимуме (×5)** переключается на особую раскладку: 5 лучей
  стоят край-в-край, начало первого — в точке использования, начало
  следующего — ровно на конце предыдущего.
